...
export const AUTH_PW = process.env.AUTH_PW || ''

//Braintree
export const BT_MERCHANT_ID = process.env['BT_MERCHANT_ID'] as string
export const BT_PUBLIC_KEY = process.env['BT_PUBLIC_KEY'] as string
export const BT_PRIVATE_KEY = process.env['BT_PRIVATE_KEY'] as string
