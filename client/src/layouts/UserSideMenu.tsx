...
export const UserSideMenu = (props: ParentCompoProps) => {
      ...
      >
        ...
        <List>
          ...
          <ListItem key="Library" disablePadding>
            <ListItemButton component={Link} to="/dashboard/user/library">
              <ListItemIcon>
                <AccountBalanceIcon />
              </ListItemIcon>
          ...
          <ListItem key="Profile" disablePadding>
            <ListItemButton component={Link} to="/dashboard/user/profile">
              <ListItemIcon>
                <PersonIcon />
              </ListItemIcon>
          ...
          <ListItem key="Authors" disablePadding>
            <ListItemButton component={Link} to="/dashboard/user/authors">
              <ListItemIcon>
                <ModeEditIcon />
              </ListItemIcon>
          ...
          <ListItem key="Borrowed Books" disablePadding>
            <ListItemButton component={Link} to="/dashboard/user/books">
              <ListItemIcon>
                <MenuBookIcon />
              </ListItemIcon>
          ...
          <ListItem key="Donate" disablePadding>
            <ListItemButton component={Link} to="/dashboard/user/donate">
              <ListItemIcon>
                <EuroIcon />
              </ListItemIcon>
